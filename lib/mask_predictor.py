...
class SimpleDecoding(nn.Module):
    def __init__(self, c4_dims, factor=2, backbone=None):
        ...
        self.fft1 = CRAFT(hidden_size, ratio=4, num_classes=hidden_size)
        ...
        self.fft2 = CRAFT(hidden_size, ratio=4, num_classes=hidden_size)
        ...
        self.fft3 = CRAFT(hidden_size, ratio=4, num_classes=hidden_size)
